...
hell.inittab = function(){
  $("#tabt").jqGrid({
      ...
      colModel:[
        ...
        {name:'medicalinfo', index:'medicalinfo', hidden:true, width:200, editable:true},
        {name:'anthropometric', index:'anthropometric', hidden:true, width:200, editable:true},
        {name:'psychological', index:'psychological', hidden:true, width:200, editable:true},
